...
import { X, Lock, Save, RefreshCw, ExternalLink } from "lucide-react";
              ...
              {!isAuthenticated ? (
                <form onSubmit={handleLogin} className="space-y-4 mt-20">
                  ...
                  <div className="space-y-2">
                    <Input
                      ...
                      data-testid="admin-panel-password"
                    />
                  ...
                  <Button
                    type="button"
                    variant="outline"
                    className="w-full border-white/10 text-white hover:bg-white/5 mt-2"
                    onClick={() => { setIsOpen(false); setLocation("/admin"); }}
                    data-testid="admin-panel-goto-full"
                  >
                ...
                <div className="space-y-8">
                  <div className="p-3 bg-white/5 rounded-lg border border-white/10 text-center">
                    <p className="text-neutral-400 text-sm">For full editing capabilities,</p>
                    <Button
                      variant="link"
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea
                        ...
                        data-testid="admin-hero-subheadline"
                      />
                    </div>
                  </div>
                  ...
                  {/* Founder Section */}
                  <div className="space-y-4">
                    <h3 className="text-lg font-semibold text-white border-b border-white/10 pb-2">Founder Profile</h3>
                    <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          className="bg-black border-white/10 text-white"
                          data-testid="admin-founder-name"
                        />
                      </div>
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          className="bg-black border-white/10 text-white"
                          data-testid="admin-founder-title"
                        />
                      </div>
                    </div>
                    <div className="space-y-2">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        className="bg-black border-white/10 text-white"
                        data-testid="admin-contact-discord"
                      />
                    </div>
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        className="bg-black border-white/10 text-white"
                        data-testid="admin-contact-whatsapp"
                      />
                    </div>
                  </div>
                </div>
