          ...
          >
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-semibold text-white/90">{data.brandName}</p>
                <div className="flex items-center gap-1.5">
...
function localFallback(input: string, brand: string): string {
  ...
  if (/^(hi|hey|hello|hola|bonjour|hallo|namaste|नमस्ते|こんにちは|你好|안녕|مرحبا|ciao|привет)/i.test(input.trim()))
    return `Hello! I'm ${brand}. How can I help you today? Feel free to ask about our services, pricing, or starting a project.`;
